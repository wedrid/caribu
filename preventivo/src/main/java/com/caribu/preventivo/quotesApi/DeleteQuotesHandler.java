...
public class DeleteQuotesHandler implements Handler<RoutingContext> {
  private static final Logger LOG = LoggerFactory.getLogger(DeleteQuotesHandler.class);
  private final Pool db;

  public DeleteQuotesHandler(final Pool db) {
    this.db = db;
  }
